...
\begin{figure}[H]
	\centering
	\vspace{1pt}
	\includegraphics[width=7cm]{resetHEADphpstorm}
	\caption{Terminal}
\end{figure}
...
\begin{figure}[H]
	\centering
	\vspace{1pt}
	\includegraphics[width=7cm]{resetHEADphpstorm2}
	\caption{Terminal}
\end{figure}
...
\begin{figure}[H]
	\centering
	\vspace{1pt}
	\includegraphics[width=7cm]{resetHEADphpstorm3}
	\caption{Terminal}
\end{figure}

\noindent These steps should be done after every commit. Now that you've syncronized the HEAD, you can commit changes as described in \secref{sec:pushtorepo}.
