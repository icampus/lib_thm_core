...
\\
After the installation starting PhpStorm will request the lisence information. Here use \texttt{Technische Hochschule Mittelhessen} for the ``User or Company Name" and the ``License key provided for you.
