...
\end{itemize}
\newpage
The following text describes the installation of PHPUnit so we are able to execute the tests.\footnote{For the original documentation see \url{https://phpunit.de/manual/current/en/installation.html}}

\subsubsection{Via wget}
\begin{tabular}{l}
...
\begin{enumerate}
	\item Create a directory for PHP binaries; e.g., C:\textbackslash bin
	\item Append C:\textbackslash bin to your PATH environment variable (see appendix \ref{app:change_env_var})
