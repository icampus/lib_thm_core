...
\subsection{PHPUnit}
In order to be able to execute tests we need to install PHPUnit.\footnote{For the original documentation see \url{https://phpunit.de/manual/current/en/installation.html}}
...
\begin{enumerate}
	...
	\item Append C:\textbackslash bin to your PATH environment variable
